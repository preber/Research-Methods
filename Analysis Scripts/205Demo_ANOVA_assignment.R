...
music <-read.file("Ch12_Example1.csv",fileEncoding='UTF-8-BOM')
...
anagram <- read.file("Ch12_Example2.csv",fileEncoding='UTF-8-BOM')
...
greener <- read.file("Ch12_Example3.csv",fileEncoding='UTF-8-BOM')
